...
import com.example.ju.streaming.WebRTC.SSLConnect;
...
public class CallSendActivity extends AppCompatActivity {
...
//            }
//        };
//        TedPermission.with(CallSendActivity.this)
...
//                .check();
        ...
        receiver_image = (CircleImageView)findViewById(R.id.receiver_image);
        receiver_id = (TextView)findViewById(R.id.receiver_id);
        call_end = (ImageButton)findViewById(R.id.call_end);
        ...
        Glide.with(this).load(receiverimage).into(receiver_image);
        receiver_id.setText(receiver);
                ...
                try {
                    ...
                    while (check) {
                        ...
                        if (getmessage != null) {
                            ...
                            if(data[0].equals("영상통화ok")){
//                                Intent intent = new Intent(CallSendActivity.this,CallActivity.class);
//                                intent.putExtra(CallActivity.EXTRA_ROOMID, roomid);
//                                startActivity(intent);

                                connectToRoom(roomid, false, false, false, 0);
                            }
                            else if(data[0].equals("영상통화no")){
                                runOnUiThread(new Runnable() {
                                    @Override
                                    public void run() {
                                        Toast.makeText(CallSendActivity.this, "상대방이 거절하였습니다.", Toast.LENGTH_SHORT).show();
                                    }
                                });
                                finish();
                            }
...
//        Log.d(TAG, "Connecting to room " + roomId + " at URL " + roomUrl);
    ...
    public void sslconnect(){
        ...
        final String Queuesource = "https://appr.tc";
        new Thread(){
            @Override
            public void run() {
                super.run();
                String PageSource = getHttpHTML_GET(Queuesource);
            }
        }.start();
    }
