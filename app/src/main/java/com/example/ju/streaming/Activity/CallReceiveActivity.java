...
//            }
//        };
//        TedPermission.with(CallReceiveActivity.this)
...
//                .check();
        ...
        caller_image = (CircleImageView)findViewById(R.id.caller_image);
        callerid = (TextView)findViewById(R.id.caller_id);
        call_ok = (ImageButton)findViewById(R.id.call_ok);
        call_cancel = (ImageButton)findViewById(R.id.call_cancel);
        ...
        Glide.with(this).load(callerimage).into(caller_image);
        callerid.setText(caller);
        ...
        call_ok.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new Thread(new Runnable() {
                    @Override
                    public void run() {
                        writer.println("영상통화ok&"+caller);
